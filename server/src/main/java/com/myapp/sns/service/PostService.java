...
//     // 게시글 작성
//     public void createPost(PostRequest request, Authentication authentication) {
...
//     // 게시글 수정
//     public void updatePost(Long postId, PostRequest request, Authentication authentication) {
//         String email = authentication.getName();
//         Post post = postRepository.findById(postId).orElseThrow();
